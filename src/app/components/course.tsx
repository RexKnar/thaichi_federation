...
const Item = ({ index, no, title, className = "" }: ItemProps) => {
  ...
  return (
    <div className={className}>
      ...
      <p className="mb-0 px-xl-7">{data.description}</p>
    </div>
  );
};
                  ...
                  <figure className=" card-img-top overlay overlay-1 hover-scale">
                    <a className="link-dark" href="/course">
                      <Image
                        width={960}
                        height={600}
                        src="/img/martialarts/Training5.jpg"
                        alt="blog"
                  ...
                  <figure className=" card-img-top overlay overlay-1 hover-scale">
                    <a className="link-dark" href="/course">
                      <Image
                        width={960}
                        height={600}
                        src="/img/martialarts/Image_Wed2.JPG"
                        alt="blog"
                        className="h-auto w-100"
                      />
                      <span className="bg" />
                  ...
                  <figure className=" card-img-top overlay overlay-1 hover-scale">
                    <a className="link-dark" href="/course">
                      <Image
                        width={960}
                        height={600}
                        src="/img/martialarts/Master_Teach1.jpeg"
                        alt="blog"
                        className="h-auto w-100"
                      />
                      <span className="bg" />
          ...
          <div className="row mt-10 gy-10 gy-lg-0 text-center d-flex align-items-center">
            <div className="col-md-6 col-lg-4 mx-auto mb-n10 mb-lg-0">
              <BlogCard2
                ...
                description="A recognized certification that validates proper training and learning standards."
                cardTop={
                  <figure className=" card-img-top overlay overlay-1 hover-scale">
                    <a className="link-dark" href="/course">
                      <Image
                        width={960}
                        height={600}
                        src="/img/martialarts/Certification_img.jpeg"
                        alt="blog"
                        className="h-auto w-100"
                      />
                      <span className="bg" />
            ...
            <div className="col-md-6 col-lg-4 mx-auto mb-n10 mb-lg-0">
              <BlogCard2
                ...
                description="The first demo session is FREE for all interested participants!"
                cardTop={
                  <figure className=" card-img-top overlay overlay-1 hover-scale">
                    <a className="link-dark" href="/course">
                      <Image
                        width={960}
                        height={600}
                        src="/img/martialarts/Taichi_Classes.JPG"
                        alt="blog"
                        className="h-auto w-100"
                      />
                      <span className="bg" />
