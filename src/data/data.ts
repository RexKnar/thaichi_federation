...
export const whyTaiChi = [
  ...
  },
  {
    ...
    Icon: Currency,
    color: color.green,
    title: 'Improve posture, strength & flexibility',
  ...
  },
  {
    ...
    Icon: Server,
    color: color.green,
    title: 'Enhance balance and coordination',
  ...
  },
  {
    ...
    Icon: Devices,
    color: color.green,
    title: 'Cultivate inner calm and energy (Qi)',
  ...
  },
  {
    ...
    Icon: Search,
    color: color.green,
    title: 'Support overall health and well-being',
    description: `Aenean lacinia bibendum nulla sed consectetur. Nulla vitae elit libero, a pharetra augue. Maecenas faucibus mollis interdum.`
  }
];
